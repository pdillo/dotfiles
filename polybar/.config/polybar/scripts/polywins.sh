...
active_text_color="#979eab"
active_bg=
active_underline="#e06c75"

inactive_text_color="#6b727e"
inactive_bg=
inactive_underline=

separator=" | "
separator_text_color="#28303b"
show="icon" # options: window_title, window_class, window_classname, icon
forbidden_classes="Polybar Conky Gmrun"
# Comment this out and you will have nothing on empty desktops
empty_desktop_message="󰌢 "
empty_desktop_message_color="#6b727e"
char_limit=20
max_windows=15
...
inactive_right="%{F-}"
separator="%{F$separator_text_color}$separator%{F-}"
...
generate_window_list() {
  ...
  if [ "$window_count" = 0 ]; then
    ...
    printf "%s" "%{F$empty_desktop_message_color}$empty_desktop_message%{F-}"
  fi
